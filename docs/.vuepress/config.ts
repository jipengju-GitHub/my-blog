...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  base: process.env.NODE_ENV === 'development' ? '/my-blog/' : '/my-blog/',
  // 主题配置
  themeConfig: {
    // 导航配置
    nav: [
    ...
    titleBadgeIcons: [ // 文章标题前图标的地址，默认主题内置图标
      'https://cdn.staticaly.com/gh/jipengju-GitHub/my-imgs@master/imgs/title1.268kurip4nls.webp',
      'https://cdn.staticaly.com/gh/jipengju-GitHub/my-imgs@master/imgs/title1.268kurip4nls.webp'
    ],
    ...
    author: {
      name: 'Penn ji', // 必需
      link: 'https://github.com/jipengju', // 可选的
    },
    ...
    footer: {
      ...
      copyrightInfo:
        'Penn Ji | <a href="https://github.com/xugaoyi/vuepress-theme-vdoing/blob/master/LICENSE" target="_blank">MIT License</a>', // 博客版权信息、备案信息等，支持a标签或换行标签</br>
    },
